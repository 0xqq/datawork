...
package top.dataworks.task.collector.log.produce;

import top.dataworks.task.collector.log.util.MessageUtil;
import top.dataworks.task.core.log.ILogProducer;
 ...
 * @see ILogProducer
 * /META-INF.services/top.dataworks.base.core.log.ILogProducer
 **/
@Slf4j
