...
import top.dataworks.task.quartz.core.StdSchedulerFactory;
...
import top.dataworks.task.quartz.listeners.ListenerManager;
import top.dataworks.task.quartz.plugin.LoggingJobHistoryPlugin;
import top.dataworks.task.scheduler.impl.InnerJobListener;
import top.dataworks.task.scheduler.impl.InnerSchedulerListener;
import top.dataworks.task.scheduler.impl.InnerTriggerListener;
...
public class SiaTaskSchedulerFactory {
    ...
    private Scheduler initScheduler(String schedName) throws SchedulerException {
        ...
        try {
            ...
            properties.put(QuartzInitConfiguration.MQUARTZ_THREAD_POOL_CLASS, "top.dataworks.mquartz.core.ext.TaskExecutorThreadPool");
            ...
            properties.put(QuartzInitConfiguration.MQUARTZ_JOB_STORE_CLASS, "top.dataworks.mquartz.core.simpl.RAMJobStore");
