...
import top.dataworks.task.quartz.ClassLoadHelper;
import top.dataworks.task.quartz.QuartzInitConfiguration;
import top.dataworks.task.quartz.ThreadPool;
import top.dataworks.task.quartz.core.simpl.DefaultThreadExecutor;
import top.dataworks.task.quartz.core.simpl.RAMJobStore;
import top.dataworks.task.quartz.core.simpl.SimpleThreadPool;
import top.dataworks.task.quartz.core.simpl.StdJobRunShellFactory;
import top.dataworks.task.quartz.exception.SchedulerConfigException;
import top.dataworks.task.quartz.exception.SchedulerException;
import top.dataworks.task.quartz.job.JobFactory;
import top.dataworks.task.quartz.job.JobStore;
import top.dataworks.task.quartz.job.matchers.EverythingMatcher;
...
import top.dataworks.task.quartz.utils.PropertiesParser;
...
public class StdSchedulerFactory implements SchedulerFactory {
    ...
    public void initialize() throws SchedulerException {
        ...
        try {
            if (propFile.exists()) {
                ...
                if (in == null) {
                    in = cl.getResourceAsStream(
                            "top/dataworks/task/quartz/core/quartz.properties");
                }
                if (in == null) {
    ...
    private Scheduler instantiate() throws SchedulerException {
        ...
        classLoadHelperClass = cfg.getStringProperty(
                ...
                "top.dataworks.task.quartz.core.simpl.CascadingClassLoadHelper");
