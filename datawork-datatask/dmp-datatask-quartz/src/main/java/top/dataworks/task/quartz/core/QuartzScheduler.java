...
package top.dataworks.task.quartz.core;

import top.dataworks.task.quartz.SchedulerSignaler;
import top.dataworks.task.quartz.ThreadPool;
import top.dataworks.task.quartz.exception.JobExecutionException;
import top.dataworks.task.quartz.exception.ObjectAlreadyExistsException;
...
import top.dataworks.task.quartz.job.*;
import top.dataworks.task.quartz.job.*;
import top.dataworks.task.quartz.job.matchers.GroupMatcher;
import top.dataworks.task.quartz.job.matchers.Matcher;
import top.dataworks.task.quartz.job.trigger.OperableTrigger;
import top.dataworks.task.quartz.job.trigger.Trigger;
import top.dataworks.task.quartz.job.trigger.TriggerKey;
import top.dataworks.task.quartz.listeners.*;
import top.dataworks.task.quartz.plugin.SchedulerPlugin;
...
import static top.dataworks.task.quartz.job.trigger.TriggerBuilder.newTrigger;
...
public class QuartzScheduler implements IQuartzScheduler {
    ...
    static {
        ...
        InputStream is = null;
        try {
            is = QuartzScheduler.class.getClassLoader().getResourceAsStream("top/dataworks/task/quartz/quartz-build.properties");
    ...
    public Date scheduleJob(JobDetail jobDetail,
        ...
        top.dataworks.task.quartz.core.Calendar cal = null;
...
//        }
     ...
     * {@link top.dataworks.task.quartz.core.Calendar}s.
     *
     * @throws SchedulerException
     */
     ...
     *                            <code>false</code>.
     */
    public void addCalendar(String calName, top.dataworks.task.quartz.core.Calendar calendar, boolean replace, boolean updateTriggers) throws SchedulerException {
        validateState();
    ...
    /**
     * <p>
     * Get the <code>{@link top.dataworks.task.quartz.core.Calendar}</code> instance with the given name.
     * </p>
     */
    public top.dataworks.task.quartz.core.Calendar getCalendar(String calName)
            throws SchedulerException {
        validateState();
