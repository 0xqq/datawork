...
import top.dataworks.task.quartz.listeners.SchedulerListener;
import top.dataworks.task.quartz.listeners.TriggerListener;
import top.dataworks.task.quartz.utils.Key;
...
public interface Scheduler {
     ...
     * invoking <code>unscheduleJob(top.dataworks.task.quartz.key.trigger.TriggerKey triggerKey)</code> several
