...
package top.dataworks.task.quartz.job.trigger.impl;

import top.dataworks.task.quartz.core.CronExpression;
import top.dataworks.task.quartz.core.CronScheduleBuilder;
import top.dataworks.task.quartz.core.ScheduleBuilder;
import top.dataworks.task.quartz.core.Scheduler;
import top.dataworks.task.quartz.exception.JobExecutionException;
import top.dataworks.task.quartz.job.JobDetail;
import top.dataworks.task.quartz.job.JobExecutionContext;
import top.dataworks.task.quartz.job.trigger.AbstractTrigger;
import top.dataworks.task.quartz.job.trigger.CronTrigger;
import top.dataworks.task.quartz.job.trigger.OperableTrigger;
import top.dataworks.task.quartz.job.trigger.Trigger;
import top.dataworks.task.quartz.utils.TriggerUtils;
...
public class CronTriggerImpl extends AbstractTrigger<CronTrigger> implements CronTrigger, CoreTrigger {
     ...
     * </p>
     *
     * @see TriggerUtils#computeFireTimesBetween(OperableTrigger, top.dataworks.task.quartz.core.Calendar, Date, Date)
     */
    @Override
     ...
     * top.dataworks.task.quartz.core.Calendar (if any)
     * </p>
     */
    @Override
     ...
     */
    @Override
    public void updateAfterMisfire(top.dataworks.task.quartz.core.Calendar cal) {
     ...
     */
    @Override
    public void triggered(top.dataworks.task.quartz.core.Calendar calendar) {
    ...
    /**
     *  
     * @see AbstractTrigger#updateWithNewCalendar(top.dataworks.task.quartz.core.Calendar, long)
     */
    @Override
    public void updateWithNewCalendar(top.dataworks.task.quartz.core.Calendar calendar, long misfireThreshold)
    {
     ...
     */
    @Override
    public Date computeFirstFireTime(top.dataworks.task.quartz.core.Calendar calendar) {
