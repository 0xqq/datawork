...
package top.dataworks.task.hunter.helper;
...
import top.dataworks.task.hunter.register.TaskRegisterListener;

import java.util.LinkedList;
import java.util.List;

/**
 * Used to detect whether the Method with the annotation <code>{@link OnlineTask}</code>
 * conforms to the specification
 *
 * @author: pengfeili23
 * @Description: OnlineTaskHelper
 * @date: 2018年7月11日 下午4:11:19
 * @see <code>{@link OnlineTask}</code>
 * @see <code>{@link TaskRegisterListener}</code>
 */
