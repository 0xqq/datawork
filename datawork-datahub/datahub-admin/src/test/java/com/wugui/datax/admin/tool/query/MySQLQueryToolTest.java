...
public class MySQLQueryToolTest {
    ...
    public void getColumnNames() {
        ...
        columns = queryTool.getColumnNames("t_datahub_job_log",jdbcDatasource.getJdbcDriverClass());
        log.info(columns.toString());
    }

    @Test
    public void getColumnsByQuerySql() throws SQLException {
        String querySql = "select l.log_file_path, c.name, c.t_datahub_job_group from t_datahub_job_log l left join job_config c on c.id = l.job_id where l.status = 1";
