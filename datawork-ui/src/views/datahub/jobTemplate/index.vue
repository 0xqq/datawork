...
<script>
import * as executor from '@/api/datahub/datax-executor'
import Cron from '@/components/Cron'
import * as jobTemp from '@/api/datahub/datax-job-template'
import waves from '@/directive/waves' // waves directive
import Pagination from '@/components/Pagination' // secondary package based on el-pagination
import * as datasourceApi from '@/api/datahub/datasource'
import * as jobProjectApi from '@/api/datahub/project'
import * as job from '@/api/datahub/datax-job-info'
